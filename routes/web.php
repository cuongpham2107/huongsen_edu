...
Route::resource('page', App\Http\Controllers\AboutUsController::class);
Route::get('p/{id}', 'App\Http\Controllers\AboutUsController@staff');
...
Route::resource('static-data', App\Http\Controllers\StaticController::class);
