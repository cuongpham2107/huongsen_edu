...
<!-- About Us Start -->
@if($about_us)
<div class="content-section-area-about bg-1" data-stellar-background-ratio="0.5" style="background: url({{Voyager::image($about_us->image)}}) repeat scroll 0 0;">
      ...
      <div class="about-left-hanf">
        <div class="box bg-cello section-relative">
          ...
          {{-- <ul class="list-marked">
            <li><i class="fa fa-check"></i> High Qualified Professionals</li>
            <li><i class="fa fa-check"></i> Affordable Prices</li>
            <li><i class="fa fa-check"></i> Successful Students</li>
          </ul> --}}
          <div class="about-btn"> <a class="button active" href="#">Liên hệ đăng ký</a> </div>
          {{-- <div class="counter-section">
            <div class="counter-boxed">
              <div class="counter animated">25</div>
              <div class="offset-top-5">
                <p>Our <span>Consultants</span></p>
              </div>
            </div>
            <div class="counter-boxed">
              <div class="counter animated">520</div>
              <div class="offset-top-5">
                <p>Happy <span>Students</span></p>
              </div>
            </div>
            <div class="counter-boxed">
              <div class="counter animated">19</div>
              <div class="offset-top-5">
    ...
    <div class="row">
      @foreach ($our_team as $item)
        <div class="col-md-3 col-sm-6">
          <div class="our-team"> <img src="{{Voyager::image($item->image)}}" alt="" width="260" height="390" style="object-fit: cover">
    ...
    <div id="home-gallery" class="owl-carousel">
      @if(count(json_decode($our_gallery->images)) > 0)
        @foreach (json_decode($our_gallery->images) as $key => $item)
          <div class="item">
            <img src="{{Voyager::image($item)}}" width="321" height="250" alt="Edugrowth - Best Template for Education" style="object-fit: cover">
          </div>
        @endforeach
      @endif
    </div>
          ...
          <div class="col-sm-6 col-md-4">
            <div class="single-blog">
              <div class="image"> <a href="{{route('posts.show',$item->slug)}}">
                <img src="{{Voyager::image($item->image)}}" alt="" width="360" height="240" style="object-fit: cover">
              </a>
              ...
              <div class="blog-content">
                ...
                <p>{{$item->excerpt}}</p>
                <a class="read-more" href="{{route('posts.show',$item->slug)}}">Xem thêm<i class="fa fa-long-arrow-right"></i> </a>
              </div>
            </div>
          </div>      
        @endforeach
