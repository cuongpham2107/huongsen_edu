                    ...
                    @if($post)
                        @foreach ($post as $item)
                            <div class="blog-list clearfix">
                                <div class="blog-list-img"> <a href="{{route('admission-articles.show',$item->slug)}}"> 
                                ...
                                <div class="blog-list-details"> <a href="{{route('admission-articles.show',$item->slug)}}">
                                        <h4>{{$item->title}}</h4>
                                    </a>
                                    ...
                                    <a href="{{route('admission-articles.show',$item->slug)}}" class="btn">Xem thêm</a>
                                </div>
                            </div>
                        @endforeach
                    @endif
